...
function getRandomPotion(random)
...
Potion = Object:new{name='',description='',icon=0,color={},canUseOutsideCombat=false,baseMagic=0,magic=0,enemyTarget=false,rarity='common',use=noop}
...
FirePotion = Potion:new{
    name='Fire Potion',description='{63} !M!.',icon=100,color={1,2,4},baseMagic=20,enemyTarget=true,rarity='common'
}
